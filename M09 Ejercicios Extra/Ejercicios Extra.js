...
function asAmirror(frase) {
  ...
  return resultado.join(' '); // Vuelve a unir las palabras en una frase
}
...
function capicua(numero) {
   ...
   // Tu código:
   const numeroStr = numero.toString(); // Convierte el número a cadena
  const numeroInvertido = numeroStr.split('').reverse().join(''); // Invierte la cadena
