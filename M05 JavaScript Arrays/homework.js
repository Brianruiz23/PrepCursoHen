...
function numeroMasGrande(arrayOfNums) {
   ...
   if (arrayOfNums.length === 0) {
      return undefined; // Si el arreglo está vacío, no hay número más grande.
    }
  
    var maximo = arrayOfNums[0]; // Inicializamos con el primer elemento del arreglo.
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   var numComoString = num.toString();
  return numComoString.charAt(0) === "9";
}
...
function todosIguales(array) {
   ...
   for (var i = 1; i < array.length; i++) {
    ...
    return true; // Si no encuentra elementos diferentes, retorna true.
}
